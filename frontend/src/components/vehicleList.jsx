        ...
        return (
            ...
            <div className='user-container'>
                ...
                <div className='link-container d-flx jc-bet'>
                    <Link className="btn btn-dark" to={{pathname: "/myVehicles/addVehicle",}}>
                        Add Vehicle
                    </Link>
                    <Link className="btn btn-dark" to={{pathname: "/mySchedule",}}>
                        Schedule Ride
                    </Link>
                    <Link className="btn btn-dark" to={{pathname: "/deleteVehicle",}}>
                        Delete Vehicle
                    </Link>
                </div>
                <div>
